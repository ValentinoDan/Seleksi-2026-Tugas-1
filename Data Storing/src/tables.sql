...
CREATE TABLE Indikator_GDP (
    ...
    persentase_gdp_dunia DECIMAL(5, 2) CHECK (persentase_gdp_dunia BETWEEN 0 AND 100),
...
CREATE TABLE Indikator_Populasi (
    ...
    persentase_populasi_dunia DECIMAL(5, 2) CHECK (persentase_populasi_dunia BETWEEN 0 AND 100),
...
CREATE TABLE Indikator_CO2 (
    ...
    persentase_emisi_co2_dunia DECIMAL(5, 2) CHECK (persentase_emisi_co2_dunia BETWEEN 0 AND 100),
...
CREATE TABLE Indikator_Energi (
    ...
    persentase_dunia DECIMAL(5, 2) CHECK (persentase_dunia BETWEEN 0 AND 100),
